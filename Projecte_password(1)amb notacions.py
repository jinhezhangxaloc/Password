...
# El longitud de la contrasenya que ha introduit son esperats i pasara al correció del contrasenya.
...
# Comprovació per cada posició del contrasenya 
    ...
    if len(errors)==0:  
    # Conprovació de longitud que te el variable "error" si no hi ha ningú error guardat llavors el longitud es 0. 

        print("El format del PASSWORD és correcte")  
        # Si no hi ha ningú error(errors=0) imprimim que el password es correcte.
